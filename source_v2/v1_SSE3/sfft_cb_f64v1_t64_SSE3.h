...
#pragma once
#ifndef _sfft_cb_f64v1_t64_SSE3_H
#define _sfft_cb_f64v1_t64_SSE3_H

#define sfft_cb_f64v1_t64_forward_SSE3(I,O,tw){    \
    ...
    \
    sfft_cb_f64v1_t16_forward_SSE3((f_vector*)(I) +  0,(f_vector*)(O) +  0,tw);    \
    sfft_cb_f64v1_t16_forward_SSE3((f_vector*)(I) + 16,(f_vector*)(O) + 16,tw);    \
    sfft_cb_f64v1_t16_forward_SSE3((f_vector*)(I) + 32,(f_vector*)(O) + 32,tw);    \
    sfft_cb_f64v1_t16_forward_SSE3((f_vector*)(I) + 48,(f_vector*)(O) + 48,tw);    \
}
#define sfft_cb_f64v1_t64_inverse_SSE3(I,O,tw){    \
    f_vector *_I = (f_vector*)(I);  \
    f_vector *_O = (f_vector*)(O);  \
    const f_vector *_w1,*_w2,*_w3;  \
    \
    sfft_cb_f64v1_t16_inverse_SSE3((f_vector*)(I) +  0,(f_vector*)(O) +  0,tw);    \
    sfft_cb_f64v1_t16_inverse_SSE3((f_vector*)(I) + 16,(f_vector*)(O) + 16,tw);    \
    sfft_cb_f64v1_t16_inverse_SSE3((f_vector*)(I) + 32,(f_vector*)(O) + 32,tw);    \
    sfft_cb_f64v1_t16_inverse_SSE3((f_vector*)(I) + 48,(f_vector*)(O) + 48,tw);    \
    \
    _w2 = (tw)->r1_2.table[6];  \
    _w1 = (tw)->r1_1.table[6];  \
    _w3 = (tw)->r1_3.table[6];  \
